          ...
          {teamLeadersList.map((leader, index) => (
            ...
            >
              <span className='flex justify-center max-w-[165px] max-h-[165px]'>
                <Image src={leader.image} alt={`Líder de célula en empresa BDS SpA`} sizes={'165'} width={165} height={165} className='rounded-full bg-bds-background-gradient-1 object-cover' />
              </span>
